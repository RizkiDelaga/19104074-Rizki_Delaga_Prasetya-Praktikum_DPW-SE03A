...
<head>
    ...
    <style>
        ...
        .sumDataMhs {
            /* Style untuk mengatur (DIV) sebagai wadah/tempat menampilkan jumlah data mahasiswa yang ada*/
            height: 30px;
            padding-left: 10px;
            padding-right: 10px;
        ...
        .sumResult {
            /* Style untuk mengatur font dan tata letaknya buat menampilkan jumlah data mahasiswa yang ada*/
            display: flex;
            justify-content: center;
            align-items: center;
            color: white;
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="simpan.php" method="post">
                <!-- pada method POST tidak menampilkan nilai/data yang dikirim pada URL -->
                ...
                <div class="form-group">
                    Upload Gambar:
                    <input type="file" name="gambar" id="gambar" accept="image/*" onchange="loadfile(event)" required> <!-- Input file yang digunakan untuk mengupload gambar  mahasiswa ke database -->

                    <div class="preview-section mt-3 mb-3"> <!-- Preview untuk melihat gambar sebelum di upload -->
                        <img id="preview-img" alt="" height="200px">

                        <script type="text/javascript"> // JS untuk menampilkan output gambar preview
                ...
                <button name="submit-data" type="submit" class="btn btn-primary btn-block mt-4">Submit</button> <!-- Button untuk submit data mahasiswa ke dalam database -->
            </form>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="sumDataMhs">
                <p class="sumResult"><?= $sumResult ?></p>
                <!-- Memanggil variabel yang berisi jumlah data mahasiswa yang ada -->
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 sm-2 gambar-mhs">
                            <img><?= $dt['gambar']; ?></img> <!-- Menampilkan foto mahasiswa -->
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a class="float-right ml-3 text-danger"
                                        href="hapus_data.php?mahasiswa_id=<?php echo $dt['id'] ?>" type="button" class="close"> <!-- Hapus data mahasiswa -->
                                        <span class="fa fa-trash"></span>
                                    </a>

                                    <a class="float-right ml-3 text-success"
                                        href="update_form.php?mahasiswa_id=<?php echo $dt['id'] ?>" type="button" class="close"> <!-- Update data mahasiswa -->
